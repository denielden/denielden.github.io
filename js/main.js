...
// cookies
const cookiesPolicy = {
    cookieGeneral: 'denielden.github.io',
    urlCookiePolicy: 'https://www.iubenda.com/privacy-policy/82057523/legal',
    cookieExpiresDays: 30,
    cookieValue: 0,
    showPopup: false,
    popup: null, 
 
    start: () => window.addEventListener('load', cookiesPolicy.onLoad, false),
    onLoad: () => {
    ...
    getCookie: () => {
        let nameOfGeneral = cookiesPolicy.cookieGeneral+'=';
    ...
    createPopup: () => {
        ...
        ele.appendChild(cookiesPolicy.popup);
    ...
    loadPopupContent: () => {
        let htmlCode = '<div id="cookieBox">' +
                            '<p>Utilizzo cookies e tecnologie simili come specificato nella <a target="_blank" href="'+cookiesPolicy.urlCookiePolicy+'" title="Privacy Policy">Privacy Policy</a>. Proseguendo nella navigazione accetti l’uso dei cookies, in caso contrario è sempre possibile abbandonare il sito.</p>' +  
                            '<button class="btn btn-sm mt-0" onClick="cookiesPolicy.loadScript()">ACCETTO</button>' + 
                        '</div>';
        return htmlCode;
    },
    loadScript: () => {
        ...
        let popupIsVisible = (cookiesPolicy.popup.style.display==='block' || cookiesPolicy.popup.style.display === '');
        if (popupIsVisible) {
